...
{
    public class SuperNATURALSynthToneCommon : IntegraBase<SuperNATURALSynthToneCommon>, IIntegraPartial
    {
        ...
        public SuperNATURALSynthToneCommon(IntegraAddress address, IntegraParts part) : base(address, 0x00000040)
        {
            Part = part;
            Name = "SuperNATURAL Synth Tone Common";
        }
        ...
        public int PhraseNumber
        {
            get
            {
                return _PhraseNumber.GetIntegraValue();
            }
            set
            {
