...
namespace Integra.Models
{
    ...
    /// </summary>
    public class PCMSynthTonePartial : IntegraBase<PCMSynthTonePartial>, IIntegraPartial, IIntegraSynthTonePartial
    {
        #region Fields

        private IntegraParts _Part;
        private IntegraSynthTonePartials _Partial;
        ...
        public PCMSynthTonePartial()
        {
            Name = "PCM Synth Tone Partial";
        }
        /// <summary>
        /// Creates and initializes a new <see cref="PCMSynthTonePartial"/> instance.
        /// </summary>
        /// <param name="address">The address of the partial.</param>
        /// <param name="part">The part of the partial.</param>
        /// <param name="partial">The partial number.</param>
        ...
        public IntegraSynthTonePartials Partial
        {
            get { return _Partial; }
            set
            {
        ...
        {
            get { return _DelayTime.GetShort(); }
            set
            {
                _DelayTime = value.GetBytes();
                NotifyPropertyChanged();
            }
        }
        [Offset(0x000C)]
        ...
        {
            get { return _LFO01Rate.GetShort(); }
            set
            {
                _LFO01Rate = value.GetBytes(); ;
                NotifyPropertyChanged();
            }
        }
        ...
        {
            get { return _LFO02Rate.GetShort(); }
            set
            {
                _LFO02Rate = value.GetBytes();
                NotifyPropertyChanged();
            }
        }
