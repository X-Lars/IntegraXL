...
{
    public class StudioSetCommonMotionalSurround : IntegraBase<StudioSetCommonMotionalSurround>
    {
        ...
        public StudioSetCommonMotionalSurround() : base(0x18000800, 0x00000010) { }
