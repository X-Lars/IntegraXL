...
{
    public class PCMSynthToneCommon : IntegraBase<PCMSynthToneCommon>, IIntegraPartial
    {
        ...
        public PCMSynthToneCommon(IntegraAddress address, IntegraParts part) : base(address, 0x00000050)
        {
            Name = "PCM Synth Tone Common";
            Part = part;
        }
