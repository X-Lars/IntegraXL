...
{
    public class SuperNATURALSynthTonePartial : IntegraBase<SuperNATURALSynthTonePartial>, IIntegraPartial, IIntegraSynthTonePartial
    {
        #region Fields
        ...
        public SuperNATURALSynthTonePartial()
        {
            Name = "SuperNATURAL Synth Tone Partial";
        }

        public SuperNATURALSynthTonePartial(IntegraAddress address, IntegraParts part, IntegraSynthTonePartials partial) : base(address, 0x0000003D)
        {
            Name = "SuperNATURAL Synth Tone Partial";
            Part = part;
            Partial = partial;
        ...
        {
            get { return _WaveNumber.GetIntegraValue(); }
            set
            {
                _WaveNumber = value.SetIntegraValue();
                NotifyPropertyChanged();
            }
        }
