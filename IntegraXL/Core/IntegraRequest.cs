...
namespace IntegraXL.Core
{
    public class IntegraRequest
    {
        ...
        public IntegraRequest() { }

        public IntegraRequest(uint request)
        {
        ...
        public IntegraRequest(byte[] request)
        {
            this[0] = request[0];
            this[1] = request[1];
            this[2] = request[2];
        ...
        public IntegraRequest(byte byte01, byte byte02, byte byte03, byte byte04)
        {
            this[0] = byte01;
            this[1] = byte02;
            this[2] = byte03;
        ...
        public static implicit operator IntegraRequest(uint request)
        {
        ...
        /// <summary>
        /// Implicitly converts an <see cref="IntegraRequest"/> to an <see cref="uint"/>.
        /// </summary>
        public static implicit operator uint(IntegraRequest instance)
        {
            ...
            return BitConverter.ToUInt32(request, 0);
        }
